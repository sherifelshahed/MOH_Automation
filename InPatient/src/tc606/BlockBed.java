...
public class BlockBed {
	...
	public void Block_bed(String usernameS, String passwordS) throws InterruptedException {
    ...
    { 
        ...
        { 
            ...
            fromdate.sendKeys("21/12/2021 19:40");
            WebElement untildate = driver.findElement(By.name("until_date"));  
            untildate.sendKeys("21/12/2021 20:40");
    }
    }
    driver.switchTo().parentFrame();
    driver.switchTo().defaultContent();
...
//	reset.click();
	//System.out.println("Apply Button is Existing. "+ApplyBTN.getText());
