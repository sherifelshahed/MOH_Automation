...
public class PrepareDischargeAdviceUI extends NUR_BlockBedpageUICheck{

	public Object OpenPrepareDischargeAdvicePage() throws InterruptedException {
		driver.switchTo().frame(1);
		driver.switchTo().frame("menuFr");
		Thread.sleep(500);
		WebElement ReleaseBlockBedPage = driver.findElement(By.id("sd18"));
	...
	public Object CheckFieldsPDA() throws InterruptedException {
		...
		WebElement ResetBTN = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr/td/input"));
		...
		WebElement Menu = driver.findElement(By.xpath("//table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr/td[3]/input"));
