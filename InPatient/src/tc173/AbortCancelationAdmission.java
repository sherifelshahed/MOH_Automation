...
public class AbortCancelationAdmission {
...
public void Abort_Cancelation_admission (String usernameS, String passwordS , String encounterId) throws InterruptedException {
	    ...
	    WebElement Abort_Cancelation  = driver.findElement(By.name("close"));
	   
	    if(Abort_Cancelation.isEnabled());
	    {
	    	 Abort_Cancelation.click();
	    	System.out.println("abort cancelation is enabled and functional");
	    	
	    }
//	    WebElement reason_btn  = driver.findElement(By.xpath("//table[2]/tbody/tr/td[2]/select"));
//	    //reason_btn.click();
//	   // reason_btn.sendKeys("d");
